...
from gildedrose.item_factory import ItemFactory
...
class GildedRoseTest(unittest.TestCase):
    ...
    def test_backstage_quality(self):
        items = [
            item_factory.create("Backstage passes to a TAFKAL80ETC concert", 15, 40)
        ]
        gilded_rose = GildedRose()
        gilded_rose.update_quality(items)
    ...
    def test_backstage_quality_double_increase(self):
        items = [
            item_factory.create("Backstage passes to a TAFKAL80ETC concert", 10, 40)
        ]
        gilded_rose = GildedRose()
        gilded_rose.update_quality(items)
    ...
    def test_backstage_quality_triple_increase(self):
        items = [
            item_factory.create("Backstage passes to a TAFKAL80ETC concert", 2, 40)
        ]
        gilded_rose = GildedRose()
        gilded_rose.update_quality(items)
    ...
    def test_backstage_quality_expires(self):
        items = [
            item_factory.create("Backstage passes to a TAFKAL80ETC concert", -6, 40)
        ]
        gilded_rose = GildedRose()
        import pdb
